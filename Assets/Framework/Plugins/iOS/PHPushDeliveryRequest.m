...
static NSString *const kPHRequestParameterCampaignID = @"msg_campaign_id";
...
+ (id)requestForApp:(NSString *)aToken secret:(NSString *)aSecret
            ...
            contentUnitID:(NSString *)aContentID campaignID:(NSString *)aCampaignID
{
    return [[[[self class] alloc] initWithApp:aToken secret:aSecret
                ...
                aContentID campaignID:aCampaignID] autorelease];
}
            ...
            contentUnitID:(NSString *)aContentID campaignID:(NSString *)aCampaignID
{
    ...
    if (nil != self)
    {
		...
		_campaignID = [aCampaignID retain];
    }
...
- (NSDictionary *)additionalParameters
{
    ...
    {
        theParameters[kPHRequestParameterCampaignID] = self.campaignID;
    }
