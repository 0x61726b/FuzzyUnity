...
static NSString *const kPHCampaignIDKey = @"cmi";
...
- (void)handleRemoteNotificationWithUserInfo:(NSDictionary *)aUserInfo
{
	...
	NSString *theCampaignID = [aUserInfo[kPHCampaignIDKey] description];
    ...
    if (nil != theContentID)
    {
        PHPublisherContentRequest *theContentRquest = [PHPublisherContentRequest requestForApp:
                    ...
                    messageID:theMessageIDString campaignID:theCampaignID];
